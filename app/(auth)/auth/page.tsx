        ...
        <div className="w-full max-w-3xl mx-auto flex flex-col lg: flex-row p-3">
            <div>
                <div
                     ...
                     onClick={()=> router.push('/')}
                        >
                <ChevronLeft className='text-gray-500 h-6 w-6 sm: h-8 sm:w-8 border-2 rounded-full p-1'></ChevronLeft>
                </div>
                 <div>
                    ...
                    {isSignUp ?
                    'join Nicholas today and discover exclusive deals on your favourite products!':
                    'welcome back to NicholasStore! Log in to continue your shopping journey'}
                     </p>
                     </div>
